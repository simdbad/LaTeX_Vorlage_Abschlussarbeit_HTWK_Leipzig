...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Optional: Zum Aktivieren eines zusätzlichen Abbildungs- und Tabellenverzeichnis des Anhangs folgendes einkommentieren:

\iffalse %Auskommentiert, ggf. entfernen

\addchap{Abbildungs- und Tabellenverzeichnis des Anhangs}
\listofalofs
\listofalots
