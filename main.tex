...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Für Nutzung des Abkürzungs- und Formelzeichenverzeichnis auskommentieren:
...
%\includepdf{Inhalte/PDFs/Sperrvermerk.pdf} %Aus dem Opal herunterladen
%\includepdf{Inhalte/PDFs/Aufgabenstellung.pdf} %Vorlage aus dem Opal herunterladen, als PDF einbinden
