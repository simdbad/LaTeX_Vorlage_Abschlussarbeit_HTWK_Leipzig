...
%Aus dem Opal herunterladen, Einbinden durch einkommentieren (Prozentzeichen entfernen):
%\includepdf{Inhalte/PDFs/Sperrvermerk.pdf}

%Aufgabenstellung, Einbinden durch einkommentieren (Prozentzeichen entfernen):
